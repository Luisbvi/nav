    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="pointer-events-auto w-full max-w-3xl rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800 dark:shadow-gray-900">
                  ...
                  {isEditing ? (
                    <>
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.97 }}
                        type="button"
                        className="rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none dark:bg-blue-700 dark:hover:bg-blue-600"
                    ...
                    <>
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.97 }}
                        type="button"
                        className="rounded-md border border-transparent bg-red-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none dark:bg-red-700 dark:hover:bg-red-600"
