  ...
  return (
    <div className="relative mx-auto mt-12 w-full max-w-7xl 2xl:mt-24">
      ...
      <div className="relative w-full overflow-visible rounded-lg bg-blue-600">
        <div className="flex flex-col items-center justify-between px-4 py-12 sm:px-6 md:px-10 lg:py-16 xl:flex-row">
          {/* Contenido del banner */}
          <div className="flex w-full flex-col items-center justify-center text-center xl:max-w-[50%] xl:items-start xl:text-left">
