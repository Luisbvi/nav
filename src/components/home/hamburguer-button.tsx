...
const HamburguerButton = ({ user }: { user: User | null }) => {
  ...
  // Definir las variantes comunes para los elementos para reutilizarlas
  const itemVariants = {
    open: {
      y: 0,
      opacity: 1,
            ...
            >
              <div className="mx-4 mt-4 flex flex-col rounded-lg border border-gray-100 bg-white p-2 font-medium shadow-lg dark:border-gray-700 dark:bg-gray-800">
                ...
                <motion.div
                  ...
                  className="flex items-center justify-between border-b border-gray-100 px-4 py-3 dark:border-gray-600"
                >
                  {user ? (
                    <div>
                ...
                >
                  ...
                  <motion.li variants={itemVariants}>
                    ...
                    >
                      Cart
                      {itemCount > 0 && (
                        <span className="-top-2 -right-2 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-xs font-bold text-white">
                          {itemCount}
                        </span>
                      )}
                    </Link>
